<template>
    ...
    <div v-for="inst in instStorage.Insts">
        <button href="#" class="button">
            ...
            <div class="Institutes" style="background-image: url(' {{ inst.img }}');">
                <div class="textInst">
                    <div style="margin-top: 15px; margin-left: 10px; margin-bottom: 30px;">{{ inst.name }}</div>
                    <div class="specText"><strong>Специальности:</strong>{{ inst.specs }}</div>
